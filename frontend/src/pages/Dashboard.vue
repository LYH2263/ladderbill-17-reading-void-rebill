...
<template>
  <div class="page dash">
    ...
    <div class="tiles" v-if="stats">
      ...
      <div class="tile"><div class="hero-num">{{ stats.reading_count }}</div><div class="muted">抄表<span v-if="stats.voided_reading_count">（已作废 {{ stats.voided_reading_count }}）</span></div></div>
